...
- Before every email_send_message call, present the exact proposed account and resolved From address, To/Cc/Bcc
  recipients, subject, complete text and HTML message bodies, attachment names, and signing choice, then ask for
  explicit
